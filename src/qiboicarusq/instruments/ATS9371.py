...
class AlazarTech_ATS9371(AlazarTech_ATS):
    """
    ...
    def __init__(self, name, **kwargs):
        ...
        self.add_parameter(name='external_sample_rate',
                           ...
                           unit='S/s',
                           vals=validators.MultiType(validators.Ints(300000000, 1000000000),
        ...
        if model != 'ATS9371':
            raise Exception("The Alazar board kind is not 'ATS9371',"
