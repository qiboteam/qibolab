...
# Qubits
qubit_LO = 4.8 * u.GHz  # Used only for mixer correction and frequency rescaling for plots or computation
qubit_IF = 110 * u.MHz
mixer_qubit_g = 0.0
mixer_qubit_phi = 0.0
...
# Resonator
resonator_LO = 7.3 * u.GHz  # Used only for mixer correction and frequency rescaling for plots or computation
...
config = {
    ...
    "controllers": {
        "con1": {
            ...
            "analog_inputs": {
                1: {"offset": 0.010400744628906252, "gain_db": 3},  # I from down-conversion
                2: {"offset": 0.006628643798828125, "gain_db": 0},  # Q from down-conversion
            },
        },
    },
    "elements": {
