        ...
        **kwargs,
        ...
        if time_hamiltonian is not None:
            ...
            if "method" in options:
                ...
                # are not traceable by JAX; reuse the Dynamiqs engine spline
                # conversion so the coefficients become jittable functions
                from jax import jit

                from .dynamiqs import _spline_function
