...
qutip_engine.py
----------------
This module provides a engine for Quantum Toolbox in Python (QuTiP) to simulate QPUs.
"""
...
class QutipSimulator:
    """Builds pulse simulator components in qutip engine. implemented by
    `qevolve` method. QutipSimulator does not interact with Pulse simulation is
    Qibolab.
    ...
    def __init__(self, model_config: dict, sim_opts: Optional[Options] = None):
        """Initializes with qutip simulation engine with model_config and qutip
        simulation options.
