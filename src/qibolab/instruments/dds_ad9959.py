...
class AD9959():
    ...
    def two_level_modulation_no_ru_rd(self):
        ...
        print("this is dont care for the profile pin configuration, hence the bits for the profile pin are being set to 0")
    ...
    # 2. replace the CFR by one with updated LS enable bit
        ...
        if self.auto_update:
            self._update_IO()        
    def amplitude_ramp_rate(self,value,channel = None,):
        """
