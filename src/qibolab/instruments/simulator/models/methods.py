...
def load_model_params(model_params:Union[dict, str])->dict:
    """Load yaml to a dictionary or returns the input if it is already a dictionary."""
...
def default_noflux_platform2simulator_channels(qubits_list:list, couplers_list:list)->dict:
