...
initial_calibration = [{
    ...
    "initial_gates": {
        ...
        "measure": [pulses.Pulse(0, 5e-6, 0.75 / 2, 100e6, 90, Rectangular(), channel=0), # I cosine
                    pulses.Pulse(0, 5e-6, 0.75 / 2, 100e6, 0, Rectangular(), channel=1)], # Q negative sine
...
class AWGSystem(AbstractExperiment):
    ...
    def start(self, nshots):
        buffer, buffers_per_acquisition, records_per_buffer, samples_per_record, time_array = self.ic.do_acquisition()
