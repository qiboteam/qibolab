...
class Pulse:
    ...
    Args:
        ...
        device (str): Instrument name where pulse is to be executed
    """
    def __init__(self, start, duration, amplitude, frequency, phase, shape, offset_i=0, offset_q=0, channel="qcm", device=""):
...
class ReadoutPulse(Pulse):
    ...
    def __init__(self, start, duration, amplitude, frequency, phase, shape, offset_i=0, offset_q=0, channel="qrm", device="", adc=""):
        super().__init__(start, duration, amplitude, frequency, phase, shape, offset_i, offset_q, channel, device)
        self.adc = adc
