...
if __name__ == "__main__":
    ...
    #print("\nRun ramsey.\n")
    #run_ramsey(resonator_freq, qubit_freq, pi_pulse_gain, pi_pulse_length, **settings["ramsey"])
    #print("\nRun Spin Echo.\n")
    #run_spin_echo(resonator_freq, qubit_freq, pi_pulse_gain, pi_pulse_length, **settings["spin_echo"])
